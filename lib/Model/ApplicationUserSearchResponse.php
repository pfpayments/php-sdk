...
/**
 * ApplicationUserSearchResponse model
 *
 * @category Class
 ...
 */
class ApplicationUserSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Application_User_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\ApplicationUser[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \PostFinanceCheckout\Sdk\Model\ApplicationUser[]|null
     */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\ApplicationUser[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
