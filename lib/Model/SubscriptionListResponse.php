...
/**
 * SubscriptionListResponse model
 *
 * @category    Class
 ...
 */
class SubscriptionListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Subscription_List_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\Subscription[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\Subscription[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
