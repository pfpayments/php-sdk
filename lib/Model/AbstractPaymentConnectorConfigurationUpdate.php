...
/**
 * AbstractPaymentConnectorConfigurationUpdate model
 *
 * @category Class
 ...
 */
class AbstractPaymentConnectorConfigurationUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Abstract.PaymentConnectorConfiguration.Update';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AbstractPaymentConnectorConfigurationUpdate., must be smaller than or equal to 100.');
        }
