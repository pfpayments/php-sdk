...
/**
 * AbstractPaymentMethodConfigurationUpdate model
 *
 * @category    Class
 ...
 */
class AbstractPaymentMethodConfigurationUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Abstract.PaymentMethodConfiguration.Update';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AbstractPaymentMethodConfigurationUpdate., must be smaller than or equal to 100.');
        }
