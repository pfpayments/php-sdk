 ...
 */
class ProductMeteredFee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductMeteredFee';
    ...
    protected static $openAPITypes = [
        ...
        'metric' => '\PostFinanceCheckout\Sdk\Model\SubscriptionMetric',
    ...
    */
     ...
     * Gets tier_pricing
     *
     * @return \PostFinanceCheckout\Sdk\Model\ProductMeteredTierPricing|null
     */
     ...
     * Sets tier_pricing
     *
     * @param \PostFinanceCheckout\Sdk\Model\ProductMeteredTierPricing|null $tier_pricing tier_pricing
     *
     * @return self
     */
    public function setTierPricing($tier_pricing)
    {
        if (is_null($tier_pricing)) {
            throw new \InvalidArgumentException('non-nullable tier_pricing cannot be null');
        }
     ...
     * Gets metric
     *
     * @return \PostFinanceCheckout\Sdk\Model\SubscriptionMetric|null
     */
     ...
     * Sets metric
     *
     * @param \PostFinanceCheckout\Sdk\Model\SubscriptionMetric|null $metric metric
     *
     * @return self
     */
