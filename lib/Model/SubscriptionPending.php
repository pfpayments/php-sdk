 ...
 */
class SubscriptionPending implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Subscription.Pending';
    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling SubscriptionPending., must be smaller than or equal to 200.');
        }
     ...
     * Sets affiliate
     *
     * @param int|null $affiliate The affiliate that led to the creation of the subscription.
     *
     * @return self
     */
    ...
    public function setReference($reference)
    {
        ...
        if ((!preg_match("/[ \\x20-\\x7e]*/", ObjectSerializer::toString($reference)))) {
            throw new \InvalidArgumentException("invalid value for \$reference when calling SubscriptionPending., must conform to the pattern /[ \\x20-\\x7e]*/.");
        }
     ...
     * Sets subscriber
     *
     * @param int|null $subscriber The subscriber that the subscription belongs to.
     *
     * @return self
     */
     ...
     * Sets token
     *
     * @param int|null $token The payment token that is used to charge the customer.
     *
     * @return self
     */
