...
/**
 * PaymentConnectorConfigurationSearchResponse model
 *
 * @category    Class
 ...
 */
class PaymentConnectorConfigurationSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Payment_Connector_Configuration_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\PaymentConnectorConfiguration[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\PaymentConnectorConfiguration[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
