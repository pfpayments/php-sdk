...
/**
 * ChargeFlowSearchResponse model
 *
 * @category Class
 ...
 */
class ChargeFlowSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Charge_Flow_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\ChargeFlow[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\ChargeFlow[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
