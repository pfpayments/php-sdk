...
/**
 * SubscriptionAffiliateSearchResponse model
 *
 * @category Class
 ...
 */
class SubscriptionAffiliateSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Subscription_Affiliate_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\SubscriptionAffiliate[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\SubscriptionAffiliate[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
