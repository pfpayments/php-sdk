...
/**
 * PaymentProcessorConfigurationSearchResponse model
 *
 * @category Class
 ...
 */
class PaymentProcessorConfigurationSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Payment_Processor_Configuration_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\PaymentProcessorConfiguration[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\PaymentProcessorConfiguration[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
