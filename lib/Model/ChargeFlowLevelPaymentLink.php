 ...
 */
class ChargeFlowLevelPaymentLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChargeFlowLevelPaymentLink';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('charge_flow_level', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \PostFinanceCheckout\Sdk\Model\ChargeFlowLevel|null
     */
     ...
     *
     * @param \PostFinanceCheckout\Sdk\Model\ChargeFlowLevel|null $charge_flow_level charge_flow_level
     *
     * @return self
     */
    public function setChargeFlowLevel($charge_flow_level)
    {
        if (is_null($charge_flow_level)) {
            throw new \InvalidArgumentException('non-nullable charge_flow_level cannot be null');
        }
     ...
     * Sets payment_link
     *
     * @param string|null $payment_link The URL provided to the customer for entering their payment details and completing the transaction.
     *
     * @return self
     */
