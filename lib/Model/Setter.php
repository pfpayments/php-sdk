 ...
 */
class Setter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Setter';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['email_address']) && (mb_strlen($this->container['email_address']) > 150)) {
    ...
    public function setMobilePhoneNumber($mobile_phone_number)
    {
        ...
        if ((mb_strlen($mobile_phone_number) > 100)) {
            throw new \InvalidArgumentException('invalid length for $mobile_phone_number when calling Setter., must be smaller than or equal to 100.');
        }
    ...
    public function setOrganizationName($organization_name)
    {
        ...
        if ((mb_strlen($organization_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $organization_name when calling Setter., must be smaller than or equal to 100.');
        }
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) > 100)) {
            throw new \InvalidArgumentException('invalid length for $city when calling Setter., must be smaller than or equal to 100.');
        }
    ...
    public function setGivenName($given_name)
    {
        ...
        if ((mb_strlen($given_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $given_name when calling Setter., must be smaller than or equal to 100.');
        }
    ...
    public function setPostcode($postcode)
    {
        ...
        if ((mb_strlen($postcode) > 40)) {
            throw new \InvalidArgumentException('invalid length for $postcode when calling Setter., must be smaller than or equal to 40.');
        }
    ...
    public function setSalesTaxNumber($sales_tax_number)
    {
        ...
        if ((mb_strlen($sales_tax_number) > 100)) {
            throw new \InvalidArgumentException('invalid length for $sales_tax_number when calling Setter., must be smaller than or equal to 100.');
        }
    ...
    public function setDependentLocality($dependent_locality)
    {
        ...
        if ((mb_strlen($dependent_locality) > 100)) {
            throw new \InvalidArgumentException('invalid length for $dependent_locality when calling Setter., must be smaller than or equal to 100.');
        }
    ...
    public function setEmailAddress($email_address)
    {
        ...
        if ((mb_strlen($email_address) > 150)) {
            throw new \InvalidArgumentException('invalid length for $email_address when calling Setter., must be smaller than or equal to 150.');
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if ((mb_strlen($phone_number) > 100)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling Setter., must be smaller than or equal to 100.');
        }
    ...
    public function setSortingCode($sorting_code)
    {
        ...
        if ((mb_strlen($sorting_code) > 100)) {
            throw new \InvalidArgumentException('invalid length for $sorting_code when calling Setter., must be smaller than or equal to 100.');
        }
    ...
    public function setStreet($street)
    {
        ...
        if ((mb_strlen($street) > 300)) {
            throw new \InvalidArgumentException('invalid length for $street when calling Setter., must be smaller than or equal to 300.');
        }
    ...
    public function setFamilyName($family_name)
    {
        ...
        if ((mb_strlen($family_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $family_name when calling Setter., must be smaller than or equal to 100.');
        }
    ...
    public function setSalutation($salutation)
    {
        ...
        if ((mb_strlen($salutation) > 20)) {
            throw new \InvalidArgumentException('invalid length for $salutation when calling Setter., must be smaller than or equal to 20.');
        }
