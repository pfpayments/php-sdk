 ...
 */
class CustomerCommentCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerComment.Create';
    ...
    */
    ...
    public function setContent($content)
    {
        ...
        if ((mb_strlen($content) > 262144)) {
            throw new \InvalidArgumentException('invalid length for $content when calling CustomerCommentCreate., must be smaller than or equal to 262144.');
        }
