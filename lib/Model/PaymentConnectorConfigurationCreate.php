...
/**
 * PaymentConnectorConfigurationCreate model
 *
 * @category    Class
 ...
 */
class PaymentConnectorConfigurationCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentConnectorConfiguration.Create';
    ...
    protected static $openAPITypes = [
        ...
        'payment_method_configuration' => 'int',
        'connector' => 'int',
        'state' => '\PostFinanceCheckout\Sdk\Model\CreationEntityState',
        'processor_configuration' => 'int'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'payment_method_configuration' => 'int64',
        'connector' => 'int64',
        'state' => null,
        'processor_configuration' => 'int64'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['payment_method_configuration'] === null) {
            $invalidProperties[] = "'payment_method_configuration' can't be null";
        }
        ...
        if ($this->container['processor_configuration'] === null) {
            $invalidProperties[] = "'processor_configuration' can't be null";
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PaymentConnectorConfigurationCreate., must be smaller than or equal to 100.');
        }
     ...
     *
     * @param int $payment_method_configuration The payment method configuration that the connector configuration belongs to.
     *
     * @return self
     */
     ...
     * Sets state
     *
     * @param \PostFinanceCheckout\Sdk\Model\CreationEntityState $state state
     *
     * @return self
     */
     ...
     *
     * @param int $processor_configuration The processor configuration that the connector configuration belongs to.
     *
     * @return self
     */
