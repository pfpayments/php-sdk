...
/**
 * SuspensionSearchResponse model
 *
 * @category Class
 ...
 */
class SuspensionSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Suspension_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\SubscriptionSuspension[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \PostFinanceCheckout\Sdk\Model\SubscriptionSuspension[]|null
     */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\SubscriptionSuspension[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
