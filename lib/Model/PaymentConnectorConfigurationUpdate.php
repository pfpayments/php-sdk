...
/**
 * PaymentConnectorConfigurationUpdate model
 *
 * @category Class
 ...
 */
class PaymentConnectorConfigurationUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentConnectorConfiguration.Update';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PaymentConnectorConfigurationUpdate., must be smaller than or equal to 100.');
        }
