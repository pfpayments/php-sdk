...
/**
 * LegalOrganizationFormSearchResponse model
 *
 * @category    Class
 ...
 */
class LegalOrganizationFormSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Legal_Organization_Form_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\LegalOrganizationForm[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\LegalOrganizationForm[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
