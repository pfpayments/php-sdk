 ...
 */
class StaticValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StaticValue';
    ...
    */
     ...
     * Sets features
     *
     * @param int[]|null $features The features that this static value belongs to.
     *
     * @return self
     */
