 ...
 */
class WebhookListenerCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookListener.Create';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling WebhookListenerCreate., must be smaller than or equal to 50.');
        }
     ...
     * Sets identity
     *
     * @param int|null $identity The identity used to sign messages.
     *
     * @return self
     */
