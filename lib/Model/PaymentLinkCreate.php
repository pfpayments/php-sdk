 ...
 */
class PaymentLinkCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentLink.Create';
    ...
    protected static $openAPITypes = [
        ...
        'protection_mode' => '\PostFinanceCheckout\Sdk\Model\PaymentLinkProtectionMode',
        'external_id' => 'string',
    ...
    */
    ...
    public function setAllowedRedirectionDomains($allowed_redirection_domains)
    {
        ...
        if ((count($allowed_redirection_domains) < 1)) {
            throw new \InvalidArgumentException('invalid length for $allowed_redirection_domains when calling PaymentLinkCreate., number of items must be greater than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PaymentLinkCreate., must be smaller than or equal to 100.');
        }
     ...
     *
     * @return \PostFinanceCheckout\Sdk\Model\PaymentLinkProtectionMode
     */
     ...
     *
     * @param \PostFinanceCheckout\Sdk\Model\PaymentLinkProtectionMode $protection_mode protection_mode
     *
     * @return self
     */
