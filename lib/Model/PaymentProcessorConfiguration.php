 ...
 */
class PaymentProcessorConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentProcessorConfiguration';
    ...
    */
     ...
     *
     * @param bool|null $application_managed Whether the processor configuration is managed by the application and therefore cannot be changed.
     *
     * @return self
     */
     ...
     * Sets contract_id
     *
     * @param int|null $contract_id The ID of the payment contract the processor configuration is linked to.
     *
     * @return self
     */
