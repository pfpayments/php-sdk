 ...
 */
class TwoFactorAuthenticationType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TwoFactorAuthenticationType';
    ...
    */
     ...
     * Sets feature
     *
     * @param int|null $feature The feature that this type belongs to.
     *
     * @return self
     */
     ...
     * Sets icon
     *
     * @param string|null $icon The identifier of the icon representing this type.
     *
     * @return self
     */
