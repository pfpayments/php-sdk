 ...
 */
class SubscriptionComponentReferenceConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionComponentReferenceConfiguration';
    ...
    protected static array $openAPINullables = [
        'quantity' => false,
        'product_component_reference_id' => false
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('product_component_reference_id', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets quantity
     *
     * @param float|null $quantity The quantity that should be applied to the component.
     *
     * @return self
     */
     ...
     *
     * @param int|null $product_component_reference_id The ID of the component reference that is being configured.
     *
     * @return self
     */
    public function setProductComponentReferenceId($product_component_reference_id)
    {
        if (is_null($product_component_reference_id)) {
            throw new \InvalidArgumentException('non-nullable product_component_reference_id cannot be null');
        }
