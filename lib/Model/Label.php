...
class Label implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('content_as_string', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $content_as_string The label's content formatted as string.
     *
     * @return self
     */
    public function setContentAsString($content_as_string)
    {
        if (is_null($content_as_string)) {
            throw new \InvalidArgumentException('non-nullable content_as_string cannot be null');
        }
     ...
     * Gets descriptor
     *
     * @return \PostFinanceCheckout\Sdk\Model\LabelDescriptor|null
     */
     ...
     * Sets descriptor
     *
     * @param \PostFinanceCheckout\Sdk\Model\LabelDescriptor|null $descriptor descriptor
     *
     * @return self
     */
     ...
     * Sets content
     *
     * @param mixed|null $content The label's actual content.
     *
     * @return self
     */
