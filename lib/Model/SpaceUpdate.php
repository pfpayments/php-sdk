 ...
 */
class SpaceUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Space.Update';
    ...
    */
     ...
     * Gets postal_address
     *
     * @return \PostFinanceCheckout\Sdk\Model\SpaceAddressCreate|null
     */
     ...
     * Sets postal_address
     *
     * @param \PostFinanceCheckout\Sdk\Model\SpaceAddressCreate|null $postal_address postal_address
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SpaceUpdate., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($name) < 3)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SpaceUpdate., must be bigger than or equal to 3.');
        }
