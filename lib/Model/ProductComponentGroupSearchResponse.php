...
/**
 * ProductComponentGroupSearchResponse model
 *
 * @category    Class
 ...
 */
class ProductComponentGroupSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Product_Component_Group_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\SubscriptionProductComponentGroup[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\SubscriptionProductComponentGroup[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
