...
class RefundCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets reductions
     *
     * @return \PostFinanceCheckout\Sdk\Model\LineItemReductionCreate[]|null
     */
     ...
     * Sets reductions
     *
     * @param \PostFinanceCheckout\Sdk\Model\LineItemReductionCreate[]|null $reductions The reductions applied on the original transaction items, detailing specific adjustments associated with the refund.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param \PostFinanceCheckout\Sdk\Model\RefundType $type type
     *
     * @return self
     */
