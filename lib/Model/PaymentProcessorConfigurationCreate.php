...
/**
 * PaymentProcessorConfigurationCreate model
 *
 * @category Class
 ...
 */
class PaymentProcessorConfigurationCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentProcessorConfiguration.Create';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PaymentProcessorConfigurationCreate., must be smaller than or equal to 100.');
        }
