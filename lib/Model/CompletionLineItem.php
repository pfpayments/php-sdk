 ...
 */
class CompletionLineItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CompletionLineItem';
    ...
    */
     ...
     * Sets amount
     *
     * @param float|null $amount The total amount of the line item to be captured, including taxes.
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param float|null $quantity The number of items to be captured.
     *
     * @return self
     */
