...
class PaymentMethodBrand implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('gray_image_path', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $gray_image_path The path to the payment method brand's grayscale image.
     *
     * @return self
     */
    public function setGrayImagePath($gray_image_path)
    {
        if (is_null($gray_image_path)) {
            throw new \InvalidArgumentException('non-nullable gray_image_path cannot be null');
        }
     ...
     * Sets image_path
     *
     * @param string|null $image_path The path to the payment method brand's image.
     *
     * @return self
     */
     ...
     * Sets payment_method
     *
     * @param int|null $payment_method The payment method that the brand belongs to.
     *
     * @return self
     */
