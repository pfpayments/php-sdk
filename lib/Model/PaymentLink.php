...
class PaymentLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets line_items
     *
     * @param \PostFinanceCheckout\Sdk\Model\LineItem[]|null $line_items The line items representing what is being sold. If not specified, they can be supplied via request parameters.
     *
     * @return self
     */
     ...
     *
     * @return \PostFinanceCheckout\Sdk\Model\PaymentLinkProtectionMode|null
     */
     ...
     *
     * @param \PostFinanceCheckout\Sdk\Model\PaymentLinkProtectionMode|null $protection_mode protection_mode
     *
     * @return self
     */
