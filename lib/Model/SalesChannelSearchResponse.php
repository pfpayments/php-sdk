...
/**
 * SalesChannelSearchResponse model
 *
 * @category    Class
 ...
 */
class SalesChannelSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Sales_Channel_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\SalesChannel[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\SalesChannel[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
