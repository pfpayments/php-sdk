...
/**
 * SingleSignOnUserSearchResponse model
 *
 * @category Class
 ...
 */
class SingleSignOnUserSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Single_Sign_On_User_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\SingleSignOnUser[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \PostFinanceCheckout\Sdk\Model\SingleSignOnUser[]|null
     */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\SingleSignOnUser[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
