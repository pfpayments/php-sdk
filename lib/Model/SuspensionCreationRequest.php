...
/**
 * SuspensionCreationRequest model
 *
 * @category Class
 ...
 */
class SuspensionCreationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SuspensionCreationRequest';
    ...
    */
    ...
    public function setNote($note)
    {
        ...
        if ((mb_strlen($note) > 300)) {
            throw new \InvalidArgumentException('invalid length for $note when calling SuspensionCreationRequest., must be smaller than or equal to 300.');
        }
