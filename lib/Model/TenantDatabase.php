 ...
 */
class TenantDatabase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TenantDatabase';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The name used to identify the database.
     *
     * @return self
     */
