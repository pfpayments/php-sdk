...
/**
 * AuthenticatedCardRequest model
 *
 * @category    Class
 ...
 */
class AuthenticatedCardRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuthenticatedCardRequest';
    ...
    protected static $openAPITypes = [
        'card_data' => '\PostFinanceCheckout\Sdk\Model\AuthenticatedCardDataCreate',
    ...
    */
     ...
     * Gets card_data
     *
     * @return \PostFinanceCheckout\Sdk\Model\AuthenticatedCardDataCreate|null
     */
     ...
     * Sets card_data
     *
     * @param \PostFinanceCheckout\Sdk\Model\AuthenticatedCardDataCreate|null $card_data card_data
     *
     * @return self
     */
     ...
     *
     * @param int|null $payment_method_configuration The ID of the payment method configuration to use.
     *
     * @return self
     */
