 ...
 */
class AbstractTransactionCommentActive implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Abstract.TransactionComment.Active';
