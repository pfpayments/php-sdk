 ...
 */
class CustomerCommentActive implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerComment.Active';
    ...
    */
    ...
    public function setContent($content)
    {
        ...
        if ((mb_strlen($content) > 262144)) {
            throw new \InvalidArgumentException('invalid length for $content when calling CustomerCommentActive., must be smaller than or equal to 262144.');
        }
