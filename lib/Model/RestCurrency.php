 ...
 */
class RestCurrency implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestCurrency';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('fraction_digits', $data ?? [], null);
    ...
    */
     ...
     *
     * @param int|null $fraction_digits The currency's number of decimals. When calculating amounts in this currency, the fraction digits determine the accuracy.
     *
     * @return self
     */
    public function setFractionDigits($fraction_digits)
    {
        if (is_null($fraction_digits)) {
            throw new \InvalidArgumentException('non-nullable fraction_digits cannot be null');
        }
     ...
     * Sets currency_code
     *
     * @param string|null $currency_code The currency's three-letter code (ISO 4217 format).
     *
     * @return self
     */
     ...
     * Sets numeric_code
     *
     * @param int|null $numeric_code The currency's three-digit code (ISO 4217 format).
     *
     * @return self
     */
