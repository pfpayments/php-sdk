 ...
 */
class TokenUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Token.Update';
    ...
    */
    ...
    public function setCustomerEmailAddress($customer_email_address)
    {
        ...
        if ((mb_strlen($customer_email_address) > 150)) {
            throw new \InvalidArgumentException('invalid length for $customer_email_address when calling TokenUpdate., must be smaller than or equal to 150.');
        }
    ...
    public function setTokenReference($token_reference)
    {
        ...
        if ((mb_strlen($token_reference) > 100)) {
            throw new \InvalidArgumentException('invalid length for $token_reference when calling TokenUpdate., must be smaller than or equal to 100.');
        }
        if ((!preg_match("/[ \\x20-\\x7e]*/", ObjectSerializer::toString($token_reference)))) {
            throw new \InvalidArgumentException("invalid value for \$token_reference when calling TokenUpdate., must conform to the pattern /[ \\x20-\\x7e]*/.");
        }
