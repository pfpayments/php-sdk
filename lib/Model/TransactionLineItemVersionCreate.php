 ...
 */
class TransactionLineItemVersionCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionLineItemVersion.Create';
    ...
    */
     ...
     * Sets line_items
     *
     * @param \PostFinanceCheckout\Sdk\Model\LineItemCreate[] $line_items The line items that replace the original line items in the transaction.
     *
     * @return self
     */
