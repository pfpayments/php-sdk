...
/**
 * CompletionSearchResponse model
 *
 * @category    Class
 ...
 */
class CompletionSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Completion_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\TransactionCompletion[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\TransactionCompletion[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
