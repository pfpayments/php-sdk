 ...
 */
class SubscriptionAffiliateDeleted implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionAffiliate.Deleted';
    ...
    */
    ...
    public function setReference($reference)
    {
        ...
        if ((mb_strlen($reference) > 100)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling SubscriptionAffiliateDeleted., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($reference) < 3)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling SubscriptionAffiliateDeleted., must be bigger than or equal to 3.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SubscriptionAffiliateDeleted., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 3)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SubscriptionAffiliateDeleted., must be bigger than or equal to 3.');
        }
