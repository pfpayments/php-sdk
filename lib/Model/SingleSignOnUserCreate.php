 ...
 */
class SingleSignOnUserCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SingleSignOnUser.Create';
    ...
    */
    ...
    public function setFirstname($firstname)
    {
        ...
        if ((mb_strlen($firstname) > 100)) {
            throw new \InvalidArgumentException('invalid length for $firstname when calling SingleSignOnUserCreate., must be smaller than or equal to 100.');
        }
    ...
    public function setLastname($lastname)
    {
        ...
        if ((mb_strlen($lastname) > 100)) {
            throw new \InvalidArgumentException('invalid length for $lastname when calling SingleSignOnUserCreate., must be smaller than or equal to 100.');
        }
     ...
     * Sets provider
     *
     * @param int $provider The single sign-on provider that this user belongs to.
     *
     * @return self
     */
