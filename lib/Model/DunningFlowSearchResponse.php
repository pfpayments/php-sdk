...
/**
 * DunningFlowSearchResponse model
 *
 * @category Class
 ...
 */
class DunningFlowSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Dunning_Flow_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\DunningFlow[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\DunningFlow[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
