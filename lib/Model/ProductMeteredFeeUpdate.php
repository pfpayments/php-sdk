...
class ProductMeteredFeeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductMeteredFee.Update';
    ...
    */
     ...
     * Sets metric
     *
     * @param int|null $metric The metric used to determine the resource consumption billed to the customer.
     *
     * @return self
     */
