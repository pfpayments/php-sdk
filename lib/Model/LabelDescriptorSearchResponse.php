...
/**
 * LabelDescriptorSearchResponse model
 *
 * @category Class
 ...
 */
class LabelDescriptorSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Label_Descriptor_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\LabelDescriptor[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\LabelDescriptor[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
