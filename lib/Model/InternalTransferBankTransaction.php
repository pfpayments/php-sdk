 ...
 */
class InternalTransferBankTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InternalTransferBankTransaction';
    ...
    protected static array $openAPINullables = [
        'source_bank_transaction' => false,
        'linked_space_id' => false,
        'target_bank_transaction' => false,
        'id' => false,
        'version' => false
    ];
    ...
    {
        $this->setIfExists('source_bank_transaction', $data ?? [], null);
        $this->setIfExists('linked_space_id', $data ?? [], null);
        $this->setIfExists('target_bank_transaction', $data ?? [], null);
    ...
    */
     ...
     *
     * @param \PostFinanceCheckout\Sdk\Model\BankTransaction|null $source_bank_transaction source_bank_transaction
     *
     * @return self
     */
    public function setSourceBankTransaction($source_bank_transaction)
    {
        if (is_null($source_bank_transaction)) {
            throw new \InvalidArgumentException('non-nullable source_bank_transaction cannot be null');
        }
     ...
     *
     * @param \PostFinanceCheckout\Sdk\Model\BankTransaction|null $target_bank_transaction target_bank_transaction
     *
     * @return self
     */
    public function setTargetBankTransaction($target_bank_transaction)
    {
        if (is_null($target_bank_transaction)) {
            throw new \InvalidArgumentException('non-nullable target_bank_transaction cannot be null');
        }
