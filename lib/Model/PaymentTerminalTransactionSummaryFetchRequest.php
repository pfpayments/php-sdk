...
/**
 * PaymentTerminalTransactionSummaryFetchRequest model
 *
 * @category    Class
 ...
 */
class PaymentTerminalTransactionSummaryFetchRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaymentTerminalTransactionSummaryFetchRequest';
     ...
     * Sets format
     *
     * @param \PostFinanceCheckout\Sdk\Model\TerminalReceiptFormat $format The format determines in what format the receipt will be returned in.
     *
     * @return $this
     */
     ...
     * Sets summary_id
     *
     * @param int $summary_id The id of the transaction summary receipt whose content should be returned.
     *
     * @return $this
     */
