 ...
 */
class HumanUserUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HumanUser.Update';
    ...
    */
    ...
    public function setMobilePhoneNumber($mobile_phone_number)
    {
        ...
        if ((mb_strlen($mobile_phone_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $mobile_phone_number when calling HumanUserUpdate., must be smaller than or equal to 30.');
        }
    ...
    public function setEmailAddress($email_address)
    {
        ...
        if ((mb_strlen($email_address) > 128)) {
            throw new \InvalidArgumentException('invalid length for $email_address when calling HumanUserUpdate., must be smaller than or equal to 128.');
        }
    ...
    public function setFirstname($firstname)
    {
        ...
        if ((mb_strlen($firstname) > 100)) {
            throw new \InvalidArgumentException('invalid length for $firstname when calling HumanUserUpdate., must be smaller than or equal to 100.');
        }
    ...
    public function setLastname($lastname)
    {
        ...
        if ((mb_strlen($lastname) > 100)) {
            throw new \InvalidArgumentException('invalid length for $lastname when calling HumanUserUpdate., must be smaller than or equal to 100.');
        }
