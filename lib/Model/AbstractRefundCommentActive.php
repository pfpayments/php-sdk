 ...
 */
class AbstractRefundCommentActive implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Abstract.RefundComment.Active';
