 ...
 */
class LineItemReduction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LineItemReduction';
    ...
    */
     ...
     *
     * @param float|null $quantity_reduction The quantity removed or reduced from the line item. This value reflects the decrease in the item count due to the reduction.
     *
     * @return self
     */
     ...
     *
     * @param float|null $unit_price_reduction The monetary amount by which the line item's unit price is discounted. This reduction adjusts the price without altering the quantity.
     *
     * @return self
     */
     ...
     *
     * @param string|null $line_item_unique_id The unique identifier of the line item to which the reduction is applied. This ID ensures the reduction is accurately associated with the correct item.
     *
     * @return self
     */
