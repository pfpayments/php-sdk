 ...
 */
class SingleSignOnUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SingleSignOnUser';
    ...
    */
    ...
    public function setFirstname($firstname)
    {
        ...
        if ((mb_strlen($firstname) > 100)) {
            throw new \InvalidArgumentException('invalid length for $firstname when calling SingleSignOnUser., must be smaller than or equal to 100.');
        }
     ...
     * Sets provider
     *
     * @param int|null $provider The single sign-on provider that this user belongs to.
     *
     * @return self
     */
    ...
    public function setLastname($lastname)
    {
        ...
        if ((mb_strlen($lastname) > 100)) {
            throw new \InvalidArgumentException('invalid length for $lastname when calling SingleSignOnUser., must be smaller than or equal to 100.');
        }
