 ...
 */
class WalletType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WalletType';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('navigation_path', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $navigation_path navigation_path
     *
     * @return self
     */
    public function setNavigationPath($navigation_path)
    {
        if (is_null($navigation_path)) {
            throw new \InvalidArgumentException('non-nullable navigation_path cannot be null');
        }
