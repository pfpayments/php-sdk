...
class Condition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'condition_type' => '\PostFinanceCheckout\Sdk\Model\ConditionType',
        'id' => 'int',
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The name used to identify the condition.
     *
     * @return self
     */
     ...
     * Sets condition_type
     *
     * @param \PostFinanceCheckout\Sdk\Model\ConditionType|null $condition_type condition_type
     *
     * @return self
     */
