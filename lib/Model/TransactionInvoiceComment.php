 ...
 */
class TransactionInvoiceComment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionInvoiceComment';
    ...
    protected static $openAPITypes = [
        ...
        'edited_on' => '\DateTime',
        'created_on' => '\DateTime',
        'transaction_invoice' => '\PostFinanceCheckout\Sdk\Model\TransactionInvoice',
        'version' => 'int',
        'content' => 'string'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('transaction_invoice', $data ?? [], null);
    ...
    */
     ...
     *
     * @param \PostFinanceCheckout\Sdk\Model\TransactionInvoice|null $transaction_invoice transaction_invoice
     *
     * @return self
     */
    public function setTransactionInvoice($transaction_invoice)
    {
        if (is_null($transaction_invoice)) {
            throw new \InvalidArgumentException('non-nullable transaction_invoice cannot be null');
        }
