 ...
 */
class SubscriberCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Subscriber.Create';
    ...
    */
    ...
    public function setReference($reference)
    {
        ...
        if ((mb_strlen($reference) > 100)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling SubscriberCreate., must be smaller than or equal to 100.');
        }
        if ((!preg_match("/[ \\x20-\\x7e]*/", ObjectSerializer::toString($reference)))) {
            throw new \InvalidArgumentException("invalid value for \$reference when calling SubscriberCreate., must conform to the pattern /[ \\x20-\\x7e]*/.");
        }
    ...
    public function setEmailAddress($email_address)
    {
        ...
        if ((mb_strlen($email_address) > 254)) {
            throw new \InvalidArgumentException('invalid length for $email_address when calling SubscriberCreate., must be smaller than or equal to 254.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling SubscriberCreate., must be smaller than or equal to 200.');
        }
