...
/**
 * ChargeAttemptSearchResponse model
 *
 * @category Class
 ...
 */
class ChargeAttemptSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Charge_Attempt_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\ChargeAttempt[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\ChargeAttempt[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
