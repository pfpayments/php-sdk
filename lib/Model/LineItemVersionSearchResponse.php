...
/**
 * LineItemVersionSearchResponse model
 *
 * @category    Class
 ...
 */
class LineItemVersionSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Line_Item_Version_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\TransactionLineItemVersion[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\TransactionLineItemVersion[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
