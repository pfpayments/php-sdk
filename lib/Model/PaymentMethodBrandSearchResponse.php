...
/**
 * PaymentMethodBrandSearchResponse model
 *
 * @category Class
 ...
 */
class PaymentMethodBrandSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Payment_Method_Brand_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\PaymentMethodBrand[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\PaymentMethodBrand[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
