...
/**
 * ProductVersionSearchResponse model
 *
 * @category Class
 ...
 */
class ProductVersionSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Product_Version_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\SubscriptionProductVersion[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\SubscriptionProductVersion[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
