...
/**
 * PaymentProcessorSearchResponse model
 *
 * @category    Class
 ...
 */
class PaymentProcessorSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Payment_Processor_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\PaymentProcessor[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\PaymentProcessor[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
