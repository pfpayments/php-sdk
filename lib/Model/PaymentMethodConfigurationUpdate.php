...
/**
 * PaymentMethodConfigurationUpdate model
 *
 * @category Class
 ...
 */
class PaymentMethodConfigurationUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentMethodConfiguration.Update';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PaymentMethodConfigurationUpdate., must be smaller than or equal to 100.');
        }
