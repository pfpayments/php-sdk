...
/**
 * SubscriptionLedgerEntrySearchResponse model
 *
 * @category Class
 ...
 */
class SubscriptionLedgerEntrySearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Subscription_Ledger_Entry_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\SubscriptionLedgerEntry[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\SubscriptionLedgerEntry[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
