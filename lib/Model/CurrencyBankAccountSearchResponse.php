...
/**
 * CurrencyBankAccountSearchResponse model
 *
 * @category    Class
 ...
 */
class CurrencyBankAccountSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Currency_Bank_Account_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\CurrencyBankAccount[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\CurrencyBankAccount[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
