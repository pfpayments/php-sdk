 ...
 */
class RenderedDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RenderedDocument';
    ...
    */
     ...
     *
     * @param int|null $document_template_type The document's template type
     *
     * @return self
     */
     ...
     * Sets data
     *
     * @param string|null $data The binary data of the document
     *
     * @return self
     */
     ...
     * Sets mime_type
     *
     * @param string|null $mime_type The document's content type
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string|null $title The title of the rendered document
     *
     * @return self
     */
