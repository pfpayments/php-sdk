...
class CustomerCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Customer.Create';
    ...
    */
    ...
    public function setEmailAddress($email_address)
    {
        ...
        if ((mb_strlen($email_address) > 254)) {
            throw new \InvalidArgumentException('invalid length for $email_address when calling CustomerCreate., must be smaller than or equal to 254.');
        }
    ...
    public function setFamilyName($family_name)
    {
        ...
        if ((mb_strlen($family_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $family_name when calling CustomerCreate., must be smaller than or equal to 100.');
        }
    ...
    public function setGivenName($given_name)
    {
        ...
        if ((mb_strlen($given_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $given_name when calling CustomerCreate., must be smaller than or equal to 100.');
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling CustomerCreate., must be smaller than or equal to 100.');
        }
        if ((!preg_match("/[ \\x20-\\x7e]*/", ObjectSerializer::toString($customer_id)))) {
            throw new \InvalidArgumentException("invalid value for \$customer_id when calling CustomerCreate., must conform to the pattern /[ \\x20-\\x7e]*/.");
        }
