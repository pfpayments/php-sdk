 ...
 */
class ManualTaskAction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManualTaskAction';
    ...
    */
     ...
     * Sets task_type
     *
     * @param int|null $task_type The type of manual tasks this action belongs to.
     *
     * @return self
     */
     ...
     * Gets style
     *
     * @return \PostFinanceCheckout\Sdk\Model\ManualTaskActionStyle|null
     */
     ...
     * Sets style
     *
     * @param \PostFinanceCheckout\Sdk\Model\ManualTaskActionStyle|null $style style
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param array<string,string>|null $label The action's label.
     *
     * @return self
     */
