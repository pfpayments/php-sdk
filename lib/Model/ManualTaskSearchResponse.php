...
/**
 * ManualTaskSearchResponse model
 *
 * @category Class
 ...
 */
class ManualTaskSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Manual_Task_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\ManualTask[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \PostFinanceCheckout\Sdk\Model\ManualTask[]|null
     */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\ManualTask[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
