 ...
 */
class ProductMeteredTierFee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductMeteredTierFee';
    ...
    protected static $openAPITypes = [
        'start_range' => 'float',
        'metered_fee' => '\PostFinanceCheckout\Sdk\Model\ProductMeteredFee',
        'fee' => '\PostFinanceCheckout\Sdk\Model\PersistableCurrencyAmount[]',
        'id' => 'int',
        'version' => 'int'
    ];
    ...
    */
     ...
     * Gets metered_fee
     *
     * @return \PostFinanceCheckout\Sdk\Model\ProductMeteredFee|null
     */
     ...
     * Sets metered_fee
     *
     * @param \PostFinanceCheckout\Sdk\Model\ProductMeteredFee|null $metered_fee metered_fee
     *
     * @return self
     */
     ...
     * Sets fee
     *
     * @param \PostFinanceCheckout\Sdk\Model\PersistableCurrencyAmount[]|null $fee The amount charged to the customer for each consumed unit at the end of a billing cycle.
     *
     * @return self
     */
