 ...
 */
class ManualTaskType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManualTaskType';
    ...
    */
     ...
     * Sets features
     *
     * @param \PostFinanceCheckout\Sdk\Model\Feature[]|null $features The features that this type belongs to.
     *
     * @return self
     */
