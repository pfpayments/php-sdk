...
class DocumentTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'type' => '\PostFinanceCheckout\Sdk\Model\DocumentTemplateType',
        'version' => 'int'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('template_resource', $data ?? [], null);
    ...
    */
     ...
     *
     * @param bool|null $delivery_enabled Whether documents of this template should be delivered.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $default_template Whether this is the default document template which is used whenever no specific template is specified for the same template type.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name used to identify the document template.
     *
     * @return self
     */
     ...
     *
     * @param string|null $template_resource The resource path to a custom template to be used to generate PDF documents.
     *
     * @return self
     */
    public function setTemplateResource($template_resource)
    {
        if (is_null($template_resource)) {
            throw new \InvalidArgumentException('non-nullable template_resource cannot be null');
        }
     ...
     * Gets type
     *
     * @return \PostFinanceCheckout\Sdk\Model\DocumentTemplateType|null
     */
     ...
     * Sets type
     *
     * @param \PostFinanceCheckout\Sdk\Model\DocumentTemplateType|null $type type
     *
     * @return self
     */
