...
/**
 * WebhookURLSearchResponse model
 *
 * @category Class
 ...
 */
class WebhookURLSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Webhook_URL_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\WebhookUrl[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\WebhookUrl[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
