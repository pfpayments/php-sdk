 ...
 */
class SubscriptionAffiliateDeleting implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionAffiliate.Deleting';
    ...
    */
     ...
     * Sets reference
     *
     * @param string|null $reference The reference used to identify the affiliate.
     *
     * @return self
     */
    public function setReference($reference)
    {
        ...
        if ((mb_strlen($reference) > 100)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling SubscriptionAffiliateDeleting., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($reference) < 3)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling SubscriptionAffiliateDeleting., must be bigger than or equal to 3.');
        }
     ...
     * Sets name
     *
     * @param string|null $name The name used to identify the affiliate.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SubscriptionAffiliateDeleting., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 3)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SubscriptionAffiliateDeleting., must be bigger than or equal to 3.');
        }
