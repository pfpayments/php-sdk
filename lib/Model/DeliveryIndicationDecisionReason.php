 ...
 */
class DeliveryIndicationDecisionReason implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeliveryIndicationDecisionReason';
