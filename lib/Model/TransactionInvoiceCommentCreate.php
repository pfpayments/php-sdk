 ...
 */
class TransactionInvoiceCommentCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionInvoiceComment.Create';
    ...
    */
    ...
    public function setContent($content)
    {
        ...
        if ((mb_strlen($content) > 262144)) {
            throw new \InvalidArgumentException('invalid length for $content when calling TransactionInvoiceCommentCreate., must be smaller than or equal to 262144.');
        }
