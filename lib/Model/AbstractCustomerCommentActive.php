 ...
 */
class AbstractCustomerCommentActive implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Abstract.CustomerComment.Active';
