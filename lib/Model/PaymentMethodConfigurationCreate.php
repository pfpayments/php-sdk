...
/**
 * PaymentMethodConfigurationCreate model
 *
 * @category Class
 ...
 */
class PaymentMethodConfigurationCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentMethodConfiguration.Create';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['data_collection_type'] === null) {
            $invalidProperties[] = "'data_collection_type' can't be null";
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PaymentMethodConfigurationCreate., must be smaller than or equal to 100.');
        }
     ...
     *
     * @param \PostFinanceCheckout\Sdk\Model\DataCollectionType $data_collection_type data_collection_type
     *
     * @return self
     */
