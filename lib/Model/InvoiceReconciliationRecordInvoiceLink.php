...
class InvoiceReconciliationRecordInvoiceLink implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'created_on' => '\DateTime',
        'id' => 'int',
        'invoice' => '\PostFinanceCheckout\Sdk\Model\TransactionInvoice',
        'linked_space_id' => 'int',
        'record' => '\PostFinanceCheckout\Sdk\Model\InvoiceReconciliationRecord'
    ];
     ...
     * Sets record
     *
     * @param \PostFinanceCheckout\Sdk\Model\InvoiceReconciliationRecord $record 
     *
     * @return $this
     */
