 ...
 */
class FeatureCategory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FeatureCategory';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('order_weight', $data ?? [], null);
    ...
    */
     ...
     * Sets order_weight
     *
     * @param int|null $order_weight When listing feature categories, they can be sorted by this number.
     *
     * @return self
     */
    public function setOrderWeight($order_weight)
    {
        if (is_null($order_weight)) {
            throw new \InvalidArgumentException('non-nullable order_weight cannot be null');
        }
