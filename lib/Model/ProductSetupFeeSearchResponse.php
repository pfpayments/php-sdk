...
/**
 * ProductSetupFeeSearchResponse model
 *
 * @category Class
 ...
 */
class ProductSetupFeeSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Product_Setup_Fee_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\ProductSetupFee[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \PostFinanceCheckout\Sdk\Model\ProductSetupFee[]|null
     */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\ProductSetupFee[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
