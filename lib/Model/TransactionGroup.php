 ...
 */
class TransactionGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionGroup';
    ...
    protected static $openAPITypes = [
        ...
        'id' => 'int',
        'state' => '\PostFinanceCheckout\Sdk\Model\TransactionGroupState',
        'version' => 'int'
    ];
    ...
    */
     ...
     * Sets begin_date
     *
     * @param \DateTime|null $begin_date The date and time when the initial transaction in the group was created.
     *
     * @return self
     */
     ...
     * Sets end_date
     *
     * @param \DateTime|null $end_date The date and time when the final transaction in the group was last updated.
     *
     * @return self
     */
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((!preg_match("/[ \\x20-\\x7e]*/", ObjectSerializer::toString($customer_id)))) {
            throw new \InvalidArgumentException("invalid value for \$customer_id when calling TransactionGroup., must conform to the pattern /[ \\x20-\\x7e]*/.");
        }
     ...
     * Gets state
     *
     * @return \PostFinanceCheckout\Sdk\Model\TransactionGroupState|null
     */
     ...
     * Sets state
     *
     * @param \PostFinanceCheckout\Sdk\Model\TransactionGroupState|null $state state
     *
     * @return self
     */
