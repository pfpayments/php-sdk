 ...
 */
class PaymentTerminalTransactionSummaryReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentTerminalTransactionSummaryReference';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('terminal_identifier', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets terminal_id
     *
     * @param int|null $terminal_id The unique identifier of the terminal.
     *
     * @return self
     */
     ...
     *
     * @param string|null $terminal_identifier The unique identifier of the terminal, that is displayed on the device.
     *
     * @return self
     */
    public function setTerminalIdentifier($terminal_identifier)
    {
        if (is_null($terminal_identifier)) {
            throw new \InvalidArgumentException('non-nullable terminal_identifier cannot be null');
        }
