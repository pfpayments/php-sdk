 ...
 */
class AbstractTransactionInvoiceCommentActive implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Abstract.TransactionInvoiceComment.Active';
