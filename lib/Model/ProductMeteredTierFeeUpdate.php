...
class ProductMeteredTierFeeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'start_range' => 'float',
        'metered_fee' => 'int',
        'fee' => '\PostFinanceCheckout\Sdk\Model\PersistableCurrencyAmountUpdate[]',
        'version' => 'int'
    ];
    ...
    */
     ...
     * Sets fee
     *
     * @param \PostFinanceCheckout\Sdk\Model\PersistableCurrencyAmountUpdate[]|null $fee The amount charged to the customer for each consumed unit at the end of a billing cycle.
     *
     * @return self
     */
