...
class SubscriptionCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'product' => 'int',
        'currency' => 'string',
        'subscription' => '\PostFinanceCheckout\Sdk\Model\SubscriptionPending'
    ];
    ...
    */
     ...
     * Gets subscription
     *
     * @return \PostFinanceCheckout\Sdk\Model\SubscriptionPending|null
     */
     ...
     * Sets subscription
     *
     * @param \PostFinanceCheckout\Sdk\Model\SubscriptionPending|null $subscription subscription
     *
     * @return self
     */
