...
/**
 * SubscriptionInitializeSubscriberPresentRequest model
 *
 * @category    Class
 ...
 */
class SubscriptionInitializeSubscriberPresentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionInitializeSubscriberPresentRequest';
    ...
    */
     ...
     * Sets success_url
     *
     * @param string|null $success_url The URL that the user is redirected to if the transaction succeeds.
     *
     * @return self
     */
     ...
     * Sets failure_url
     *
     * @param string|null $failure_url The URL that the user is redirected to if the transaction fails.
     *
     * @return self
     */
