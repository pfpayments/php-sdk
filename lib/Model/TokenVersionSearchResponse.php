...
/**
 * TokenVersionSearchResponse model
 *
 * @category Class
 ...
 */
class TokenVersionSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Token_Version_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\TokenVersion[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\TokenVersion[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
