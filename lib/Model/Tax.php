...
class Tax implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['rate']) && ($this->container['rate'] > 100)) {
     ...
     * Sets rate
     *
     * @param float|null $rate The tax rate to be applied.
     *
     * @return self
     */
    public function setRate($rate)
    {
        ...
        if (($rate > 100)) {
            throw new \InvalidArgumentException('invalid value for $rate when calling Tax., must be smaller than or equal to 100.');
        }
     ...
     * Sets title
     *
     * @param string|null $title The name of the tax.
     *
     * @return self
     */
