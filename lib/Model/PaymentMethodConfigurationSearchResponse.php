...
/**
 * PaymentMethodConfigurationSearchResponse model
 *
 * @category Class
 ...
 */
class PaymentMethodConfigurationSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Payment_Method_Configuration_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\PaymentMethodConfiguration[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\PaymentMethodConfiguration[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
