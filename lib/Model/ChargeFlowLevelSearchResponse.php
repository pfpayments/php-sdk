...
/**
 * ChargeFlowLevelSearchResponse model
 *
 * @category Class
 ...
 */
class ChargeFlowLevelSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Charge_Flow_Level_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\ChargeFlowLevel[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\ChargeFlowLevel[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
