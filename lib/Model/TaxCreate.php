 ...
 */
class TaxCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Tax.Create';
    ...
    */
    ...
    public function setRate($rate)
    {
        ...
        if (($rate > 100)) {
            throw new \InvalidArgumentException('invalid value for $rate when calling TaxCreate., must be smaller than or equal to 100.');
        }
