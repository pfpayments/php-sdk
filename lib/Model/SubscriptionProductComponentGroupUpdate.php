 ...
 */
class SubscriptionProductComponentGroupUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionProductComponentGroup.Update';
    ...
    */
     ...
     *
     * @param int|null $product_version The product version that the component group belongs to.
     *
     * @return self
     */
     ...
     * Sets sort_order
     *
     * @param int|null $sort_order When listing component groups, they can be sorted by this number.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param array<string,string>|null $name The localized name of the component group that is displayed to the customer.
     *
     * @return self
     */
     ...
     * Sets optional
     *
     * @param bool|null $optional Whether the component group is optional, i.e. the customer does not have to select any component.
     *
     * @return self
     */
