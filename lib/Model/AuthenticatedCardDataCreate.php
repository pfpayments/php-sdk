...
class AuthenticatedCardDataCreate implements ModelInterface, ArrayAccess
{
     ...
     *
     * @return \PostFinanceCheckout\Sdk\Model\CardholderAuthenticationCreate
     */
     ...
     *
     * @param \PostFinanceCheckout\Sdk\Model\CardholderAuthenticationCreate $cardholder_authentication Optional authentication details for the cardholder, such as 3D Secure authentication, used when the cardholder has already been verified during the transaction for added security.
     *
     * @return $this
     */
     ...
     * Gets cryptogram
     *
     * @return \PostFinanceCheckout\Sdk\Model\CardCryptogramCreate
     */
     ...
     * Sets cryptogram
     *
     * @param \PostFinanceCheckout\Sdk\Model\CardCryptogramCreate $cryptogram An additional authentication value that enhances the security of tokenized card transactions.
     *
     * @return $this
     */
     ...
     * Sets pan_type
     *
     * @param \PostFinanceCheckout\Sdk\Model\PanType $pan_type The type of PAN or token, indicating the source or security method of the card information.
     *
     * @return $this
     */
