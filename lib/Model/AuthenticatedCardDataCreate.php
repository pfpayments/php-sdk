 ...
 */
class AuthenticatedCardDataCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuthenticatedCardData.Create';
    ...
    */
    ...
    public function setExpiryDate($expiry_date)
    {
        ...
        if ((!preg_match("/(\\d{4})-(11|12|10|0[1-9])/", ObjectSerializer::toString($expiry_date)))) {
            throw new \InvalidArgumentException("invalid value for \$expiry_date when calling AuthenticatedCardDataCreate., must conform to the pattern /(\\d{4})-(11|12|10|0[1-9])/.");
        }
    ...
    public function setCardVerificationCode($card_verification_code)
    {
        ...
        if ((!preg_match("/([0-9 ]+)/", ObjectSerializer::toString($card_verification_code)))) {
            throw new \InvalidArgumentException("invalid value for \$card_verification_code when calling AuthenticatedCardDataCreate., must conform to the pattern /([0-9 ]+)/.");
        }
    ...
    public function setPrimaryAccountNumber($primary_account_number)
    {
        ...
        if ((!preg_match("/([0-9 ]+)/", ObjectSerializer::toString($primary_account_number)))) {
            throw new \InvalidArgumentException("invalid value for \$primary_account_number when calling AuthenticatedCardDataCreate., must conform to the pattern /([0-9 ]+)/.");
        }
     ...
     *
     * @return \PostFinanceCheckout\Sdk\Model\CardholderAuthenticationCreate|null
     */
     ...
     *
     * @param \PostFinanceCheckout\Sdk\Model\CardholderAuthenticationCreate|null $cardholder_authentication cardholder_authentication
     *
     * @return self
     */
