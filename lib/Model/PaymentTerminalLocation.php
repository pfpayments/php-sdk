...
class PaymentTerminalLocation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentTerminalLocation';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The name used to identify the payment terminal location.
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \PostFinanceCheckout\Sdk\Model\PaymentTerminalLocationState|null
     */
     ...
     * Sets state
     *
     * @param \PostFinanceCheckout\Sdk\Model\PaymentTerminalLocationState|null $state state
     *
     * @return self
     */
