...
/**
 * PaymentLinkSearchResponse model
 *
 * @category Class
 ...
 */
class PaymentLinkSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Payment_Link_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\PaymentLink[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \PostFinanceCheckout\Sdk\Model\PaymentLink[]|null
     */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\PaymentLink[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
