...
/**
 * PaymentMethodSearchResponse model
 *
 * @category Class
 ...
 */
class PaymentMethodSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Payment_Method_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\PaymentMethod[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\PaymentMethod[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
