...
/**
 * DunningFlowLevelSearchResponse model
 *
 * @category Class
 ...
 */
class DunningFlowLevelSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Dunning_Flow_Level_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\DunningFlowLevel[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \PostFinanceCheckout\Sdk\Model\DunningFlowLevel[]|null
     */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\DunningFlowLevel[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
