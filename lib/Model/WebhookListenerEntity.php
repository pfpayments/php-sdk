 ...
 */
class WebhookListenerEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookListenerEntity';
    ...
    */
     ...
     * Sets name
     *
     * @param array<string,string>|null $name The name used to identify the webhook listener entity.
     *
     * @return self
     */
     ...
     * Sets technical_name
     *
     * @param string|null $technical_name The name used to programmatically identify the webhook listener entity.
     *
     * @return self
     */
