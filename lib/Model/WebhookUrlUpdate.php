 ...
 */
class WebhookUrlUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookUrl.Update';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling WebhookUrlUpdate., must be smaller than or equal to 50.');
        }
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) > 500)) {
            throw new \InvalidArgumentException('invalid length for $url when calling WebhookUrlUpdate., must be smaller than or equal to 500.');
        }
        if ((mb_strlen($url) < 9)) {
            throw new \InvalidArgumentException('invalid length for $url when calling WebhookUrlUpdate., must be bigger than or equal to 9.');
        }
