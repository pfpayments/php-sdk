...
/**
 * ProductComponentSearchResponse model
 *
 * @category Class
 ...
 */
class ProductComponentSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Product_Component_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\SubscriptionProductComponent[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\SubscriptionProductComponent[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
