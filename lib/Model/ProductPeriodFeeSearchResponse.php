...
/**
 * ProductPeriodFeeSearchResponse model
 *
 * @category Class
 ...
 */
class ProductPeriodFeeSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Product_Period_Fee_Search_Response';
    ...
    protected static $openAPITypes = [
        'data' => '\PostFinanceCheckout\Sdk\Model\ProductPeriodFee[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \PostFinanceCheckout\Sdk\Model\ProductPeriodFee[]|null
     */
     ...
     * Sets data
     *
     * @param \PostFinanceCheckout\Sdk\Model\ProductPeriodFee[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
