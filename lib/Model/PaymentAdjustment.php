...
class PaymentAdjustment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('rate_in_percentage', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['rate_in_percentage']) && ($this->container['rate_in_percentage'] > 100)) {
            $invalidProperties[] = "invalid value for 'rate_in_percentage', must be smaller than or equal to 100.";
        }
     ...
     *
     * @param float|null $amount_excluding_tax The adjustment's amount, excluding taxes.
     *
     * @return self
     */
     ...
     *
     * @param float|null $rate_in_percentage The percentage rate used to calculate the adjustment amount.
     *
     * @return self
     */
    public function setRateInPercentage($rate_in_percentage)
    {
        if (is_null($rate_in_percentage)) {
            throw new \InvalidArgumentException('non-nullable rate_in_percentage cannot be null');
        }

        if (($rate_in_percentage > 100)) {
            throw new \InvalidArgumentException('invalid value for $rate_in_percentage when calling PaymentAdjustment., must be smaller than or equal to 100.');
        }
     ...
     * Sets tax
     *
     * @param \PostFinanceCheckout\Sdk\Model\Tax|null $tax tax
     *
     * @return self
     */
     ...
     *
     * @param float|null $amount_including_tax The adjustment's amount, including taxes.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param int|null $type The type of the adjustment.
     *
     * @return self
     */
