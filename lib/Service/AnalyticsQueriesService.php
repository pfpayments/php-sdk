...
/**
 * AnalyticsQueriesService service
 *
 * @category Class
...
class AnalyticsQueriesService
{
     ...
     * @return void
     */
    public function deleteAnalyticsQueriesQueryExternalIdQueryExternalId(string $query_external_id, int $account, string $contentType = self::contentTypes['deleteAnalyticsQueriesQueryExternalIdQueryExternalId'][0])
    {
     ...
     */
    public function deleteAnalyticsQueriesQueryExternalIdQueryExternalIdWithHttpInfo(string $query_external_id, int $account, string $contentType = self::contentTypes['deleteAnalyticsQueriesQueryExternalIdQueryExternalId'][0])
    {
     ...
     */
    public function deleteAnalyticsQueriesQueryExternalIdQueryExternalIdRequest(string $query_external_id, int $account, string $contentType = self::contentTypes['deleteAnalyticsQueriesQueryExternalIdQueryExternalId'][0])
    {
     ...
     * @return void
     */
    public function deleteAnalyticsQueriesQueryTokenQueryToken(string $query_token, int $account, string $contentType = self::contentTypes['deleteAnalyticsQueriesQueryTokenQueryToken'][0])
    {
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteAnalyticsQueriesQueryTokenQueryTokenWithHttpInfo(string $query_token, int $account, string $contentType = self::contentTypes['deleteAnalyticsQueriesQueryTokenQueryToken'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteAnalyticsQueriesQueryTokenQueryTokenRequest(string $query_token, int $account, string $contentType = self::contentTypes['deleteAnalyticsQueriesQueryTokenQueryToken'][0])
    {
        ...
        if ($query_token !== null) {
            $resourcePath = str_replace(
                '{' . 'queryToken' . '}',
                ObjectSerializer::toPathValue($query_token),
                $resourcePath
            );
        }
    ...
    /**
     * Operation getAnalyticsQueries
     *
     * Get portion of query executions for account
     *
     * @param int $offset A cursor for pagination, specifies the number of query executions to skip. (required)
     * @param int $limit A limit on the number of query executions to be returned, between 1 and 100. Default is 100. (required)
     * @param int $account Specifies the ID of the account the operation should be executed in. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAnalyticsQueries'] to see the possible values for this operation
     *
     * @throws \PostFinanceCheckout\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \PostFinanceCheckout\Sdk\Model\ResultPortionModel|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse
     */
    public function getAnalyticsQueries(int $offset, int $limit, int $account, string $contentType = self::contentTypes['getAnalyticsQueries'][0])
    {
        list($response) = $this->getAnalyticsQueriesWithHttpInfo($offset, $limit, $account, $contentType);
        return $response;
    }

    /**
     * Operation getAnalyticsQueriesWithHttpInfo
     *
     * Get portion of query executions for account
     *
     * @param int $offset A cursor for pagination, specifies the number of query executions to skip. (required)
     ...
     * @throws \PostFinanceCheckout\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \PostFinanceCheckout\Sdk\Model\ResultPortionModel|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAnalyticsQueriesWithHttpInfo(int $offset, int $limit, int $account, string $contentType = self::contentTypes['getAnalyticsQueries'][0])
    {
        $request = $this->getAnalyticsQueriesRequest($offset, $limit, $account, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\PostFinanceCheckout\Sdk\Model\ResultPortionModel',
                        $request,
                        $response,
                    );
                case 400:
    ...
    /**
     * Create request for operation 'getAnalyticsQueries'
     *
     * @param int $offset A cursor for pagination, specifies the number of query executions to skip. (required)
     * @param int $limit A limit on the number of query executions to be returned, between 1 and 100. Default is 100. (required)
     * @param int $account Specifies the ID of the account the operation should be executed in. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAnalyticsQueriesRequest(int $offset, int $limit, int $account, string $contentType = self::contentTypes['getAnalyticsQueries'][0])
    {

        // verify the required parameter 'offset' is set
        if ($offset === null || (is_array($offset) && count($offset) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $offset when calling getAnalyticsQueries'
            );
        }
        ...
        if ($limit === null || (is_array($limit) && count($limit) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $limit when calling getAnalyticsQueries'
            );
        }
        ...
        if ($account === null || (is_array($account) && count($account) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account when calling getAnalyticsQueries'
            );
        }


        $resourcePath = '/analytics/queries';
        $httpMethod = 'GET';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
     ...
     */
    public function getAnalyticsQueriesQueryExternalIdQueryExternalId(string $query_external_id, int $account, string $contentType = self::contentTypes['getAnalyticsQueriesQueryExternalIdQueryExternalId'][0])
    {
     ...
     */
    public function getAnalyticsQueriesQueryExternalIdQueryExternalIdWithHttpInfo(string $query_external_id, int $account, string $contentType = self::contentTypes['getAnalyticsQueriesQueryExternalIdQueryExternalId'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAnalyticsQueriesQueryExternalIdQueryExternalIdRequest(string $query_external_id, int $account, string $contentType = self::contentTypes['getAnalyticsQueriesQueryExternalIdQueryExternalId'][0])
    {
     ...
     */
    public function getAnalyticsQueriesQueryExternalIdQueryExternalIdResult(string $query_external_id, int $account, string $contentType = self::contentTypes['getAnalyticsQueriesQueryExternalIdQueryExternalIdResult'][0])
    {
     ...
     */
    public function getAnalyticsQueriesQueryExternalIdQueryExternalIdResultWithHttpInfo(string $query_external_id, int $account, string $contentType = self::contentTypes['getAnalyticsQueriesQueryExternalIdQueryExternalIdResult'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAnalyticsQueriesQueryExternalIdQueryExternalIdResultRequest(string $query_external_id, int $account, string $contentType = self::contentTypes['getAnalyticsQueriesQueryExternalIdQueryExternalIdResult'][0])
    {
     ...
     * @return \PostFinanceCheckout\Sdk\Model\SubmittedAnalyticsQueryExecution|\PostFinanceCheckout\Sdk\Model\SubmittedAnalyticsQueryExecution|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse
     */
    public function getAnalyticsQueriesQueryTokenQueryToken(string $query_token, int $account, string $contentType = self::contentTypes['getAnalyticsQueriesQueryTokenQueryToken'][0])
    {
     ...
     * @return array of \PostFinanceCheckout\Sdk\Model\SubmittedAnalyticsQueryExecution|\PostFinanceCheckout\Sdk\Model\SubmittedAnalyticsQueryExecution|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAnalyticsQueriesQueryTokenQueryTokenWithHttpInfo(string $query_token, int $account, string $contentType = self::contentTypes['getAnalyticsQueriesQueryTokenQueryToken'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAnalyticsQueriesQueryTokenQueryTokenRequest(string $query_token, int $account, string $contentType = self::contentTypes['getAnalyticsQueriesQueryTokenQueryToken'][0])
    {
     ...
     * @return string|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse
     */
    public function getAnalyticsQueriesQueryTokenQueryTokenResult(string $query_token, int $account, string $contentType = self::contentTypes['getAnalyticsQueriesQueryTokenQueryTokenResult'][0])
    {
     ...
     * @return array of string|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAnalyticsQueriesQueryTokenQueryTokenResultWithHttpInfo(string $query_token, int $account, string $contentType = self::contentTypes['getAnalyticsQueriesQueryTokenQueryTokenResult'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAnalyticsQueriesQueryTokenQueryTokenResultRequest(string $query_token, int $account, string $contentType = self::contentTypes['getAnalyticsQueriesQueryTokenQueryTokenResult'][0])
    {
    ...
    /**
     * Operation postAnalyticsQueriesSubmit
     *
     ...
     */
    public function postAnalyticsQueriesSubmit(string $query_external_id, int $account, \PostFinanceCheckout\Sdk\Model\AnalyticsQueryExecutionRequest $analytics_query_execution_request, string $contentType = self::contentTypes['postAnalyticsQueriesSubmit'][0])
    {
    ...
    /**
     * Operation postAnalyticsQueriesSubmitWithHttpInfo
     *
     * Submit a query execution
     *
     * @param string $query_external_id A unique id to be provided for each query. The same id for different queries will be only executed the first time (required)
     ...
     */
    public function postAnalyticsQueriesSubmitWithHttpInfo(string $query_external_id, int $account, \PostFinanceCheckout\Sdk\Model\AnalyticsQueryExecutionRequest $analytics_query_execution_request, string $contentType = self::contentTypes['postAnalyticsQueriesSubmit'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    return $this->handleResponseWithDataType(
                        '\PostFinanceCheckout\Sdk\Model\AnalyticsQueryExecutionResponse',
                        $request,
                        $response,
                    );
                case 409:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postAnalyticsQueriesSubmitRequest(string $query_external_id, int $account, \PostFinanceCheckout\Sdk\Model\AnalyticsQueryExecutionRequest $analytics_query_execution_request, string $contentType = self::contentTypes['postAnalyticsQueriesSubmit'][0])
    {
        ...
        if ($account === null || (is_array($account) && count($account) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account when calling postAnalyticsQueriesSubmit'
            );
        }

        // verify the required parameter 'analytics_query_execution_request' is set
        if ($analytics_query_execution_request === null || (is_array($analytics_query_execution_request) && count($analytics_query_execution_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $analytics_query_execution_request when calling postAnalyticsQueriesSubmit'
            );
        }


        $resourcePath = '/analytics/queries/submit';
        $httpMethod = 'POST';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        ...
        // for model (json/xml)
        if (isset($analytics_query_execution_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($analytics_query_execution_request));
            } else {
                $httpBody = $analytics_query_execution_request;
            }
