...
class AnalyticsQueriesService
{
     ...
     */
    public function getAnalyticsQueries($offset, $limit, $account, string $contentType = self::contentTypes['getAnalyticsQueries'][0])
    {
     ...
     */
    public function getAnalyticsQueriesWithHttpInfo($offset, $limit, $account, string $contentType = self::contentTypes['getAnalyticsQueries'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\PostFinanceCheckout\Sdk\Model\ResultPortionModel' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\PostFinanceCheckout\Sdk\Model\ResultPortionModel' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\PostFinanceCheckout\Sdk\Model\ResultPortionModel', []),
            ...
            $returnType = '\PostFinanceCheckout\Sdk\Model\ResultPortionModel';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAnalyticsQueriesRequest($offset, $limit, $account, string $contentType = self::contentTypes['getAnalyticsQueries'][0])
    {
    ...
    public function postAnalyticsQueriesSubmitWithHttpInfo($query_external_id, $account, $analytics_query_execution_request, string $contentType = self::contentTypes['postAnalyticsQueriesSubmit'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\PostFinanceCheckout\Sdk\Model\AnalyticsQueryExecutionResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\PostFinanceCheckout\Sdk\Model\AnalyticsQueryExecutionResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
            ...
            $returnType = '\PostFinanceCheckout\Sdk\Model\AnalyticsQueryExecutionResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
