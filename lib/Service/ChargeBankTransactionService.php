...
/**
 * ChargeBankTransactionService service
 *
 * @category Class
...
class ChargeBankTransactionService {
	...
	public function countWithHttpInfo($space_id, $filter = null) {
		...
		// path params
		$resourcePath = '/charge-bank-transaction/count';
	...
	public function readWithHttpInfo($space_id, $id) {
		...
		// path params
		$resourcePath = '/charge-bank-transaction/read';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
		...
		try {
			$response = $this->apiClient->callApi(
				...
				'/charge-bank-transaction/read'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\PostFinanceCheckout\Sdk\Model\ChargeBankTransaction', $response->getHeaders()));
		} catch (ApiException $e) {
			switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \PostFinanceCheckout\Sdk\Model\EntityQuery $query The query restricts the charge bank transactions which are returned by the search. (required)
	 * @throws \PostFinanceCheckout\Sdk\ApiException
	 * @throws \PostFinanceCheckout\Sdk\VersioningException
	 * @throws \PostFinanceCheckout\Sdk\Http\ConnectionException
	 * @return \PostFinanceCheckout\Sdk\Model\ChargeBankTransaction[]
	...
	public function searchWithHttpInfo($space_id, $query) {
		...
		// path params
		$resourcePath = '/charge-bank-transaction/search';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$headerParams,
				'\PostFinanceCheckout\Sdk\Model\ChargeBankTransaction[]',
				'/charge-bank-transaction/search'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\PostFinanceCheckout\Sdk\Model\ChargeBankTransaction[]', $response->getHeaders()));
		} catch (ApiException $e) {
			switch ($e->getCode()) {
