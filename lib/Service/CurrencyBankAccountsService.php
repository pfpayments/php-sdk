...
class CurrencyBankAccountsService
{
     ...
     */
    public function getPaymentCurrencyBankAccounts(int $space, ?int $after = null, ?int $before = null, ?array $expand = null, ?int $limit = null, ?string $order = null, string $contentType = self::contentTypes['getPaymentCurrencyBankAccounts'][0])
    {
     ...
     */
    public function getPaymentCurrencyBankAccountsWithHttpInfo(int $space, ?int $after = null, ?int $before = null, ?array $expand = null, ?int $limit = null, ?string $order = null, string $contentType = self::contentTypes['getPaymentCurrencyBankAccounts'][0])
    {
     ...
     */
    public function getPaymentCurrencyBankAccountsRequest(int $space, ?int $after = null, ?int $before = null, ?array $expand = null, ?int $limit = null, ?string $order = null, string $contentType = self::contentTypes['getPaymentCurrencyBankAccounts'][0])
    {
     ...
     */
    public function getPaymentCurrencyBankAccountsId(int $id, int $space, ?array $expand = null, string $contentType = self::contentTypes['getPaymentCurrencyBankAccountsId'][0])
    {
     ...
     */
    public function getPaymentCurrencyBankAccountsIdWithHttpInfo(int $id, int $space, ?array $expand = null, string $contentType = self::contentTypes['getPaymentCurrencyBankAccountsId'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getPaymentCurrencyBankAccountsIdRequest(int $id, int $space, ?array $expand = null, string $contentType = self::contentTypes['getPaymentCurrencyBankAccountsId'][0])
    {
     ...
     */
    public function getPaymentCurrencyBankAccountsSearch(int $space, ?array $expand = null, ?int $limit = null, ?int $offset = null, ?string $order = null, ?string $query = null, string $contentType = self::contentTypes['getPaymentCurrencyBankAccountsSearch'][0])
    {
     ...
     */
    public function getPaymentCurrencyBankAccountsSearchWithHttpInfo(int $space, ?array $expand = null, ?int $limit = null, ?int $offset = null, ?string $order = null, ?string $query = null, string $contentType = self::contentTypes['getPaymentCurrencyBankAccountsSearch'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getPaymentCurrencyBankAccountsSearchRequest(int $space, ?array $expand = null, ?int $limit = null, ?int $offset = null, ?string $order = null, ?string $query = null, string $contentType = self::contentTypes['getPaymentCurrencyBankAccountsSearch'][0])
    {
