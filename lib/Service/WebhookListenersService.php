...
class WebhookListenersService
{
     ...
     */
    public function deleteWebhooksListenersBulk($space, $request_body, string $contentType = self::contentTypes['deleteWebhooksListenersBulk'][0])
    {
     ...
     */
    public function deleteWebhooksListenersBulkWithHttpInfo($space, $request_body, string $contentType = self::contentTypes['deleteWebhooksListenersBulk'][0])
    {
     ...
     */
    public function deleteWebhooksListenersBulkRequest($space, $request_body, string $contentType = self::contentTypes['deleteWebhooksListenersBulk'][0])
    {
     ...
     * @return void
     */
    public function deleteWebhooksListenersId($id, $space, string $contentType = self::contentTypes['deleteWebhooksListenersId'][0])
    {
     ...
     */
    public function deleteWebhooksListenersIdWithHttpInfo($id, $space, string $contentType = self::contentTypes['deleteWebhooksListenersId'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteWebhooksListenersIdRequest($id, $space, string $contentType = self::contentTypes['deleteWebhooksListenersId'][0])
    {
     ...
     */
    public function getWebhooksListeners($space, $after = null, $before = null, $expand = null, $limit = null, $order = null, string $contentType = self::contentTypes['getWebhooksListeners'][0])
    {
     ...
     */
    public function getWebhooksListenersWithHttpInfo($space, $after = null, $before = null, $expand = null, $limit = null, $order = null, string $contentType = self::contentTypes['getWebhooksListeners'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\PostFinanceCheckout\Sdk\Model\WebhookListenerListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\PostFinanceCheckout\Sdk\Model\WebhookListenerListResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\PostFinanceCheckout\Sdk\Model\WebhookListenerListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\PostFinanceCheckout\Sdk\Model\WebhookListenerListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getWebhooksListenersRequest($space, $after = null, $before = null, $expand = null, $limit = null, $order = null, string $contentType = self::contentTypes['getWebhooksListeners'][0])
    {
     ...
     */
    public function getWebhooksListenersId($id, $space, $expand = null, string $contentType = self::contentTypes['getWebhooksListenersId'][0])
    {
     ...
     */
    public function getWebhooksListenersIdWithHttpInfo($id, $space, $expand = null, string $contentType = self::contentTypes['getWebhooksListenersId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\PostFinanceCheckout\Sdk\Model\WebhookListener' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\PostFinanceCheckout\Sdk\Model\WebhookListener' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\PostFinanceCheckout\Sdk\Model\WebhookListener', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\PostFinanceCheckout\Sdk\Model\WebhookListener';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getWebhooksListenersIdRequest($id, $space, $expand = null, string $contentType = self::contentTypes['getWebhooksListenersId'][0])
    {
     ...
     */
    public function getWebhooksListenersSearch($space, $expand = null, $limit = null, $offset = null, $order = null, $query = null, string $contentType = self::contentTypes['getWebhooksListenersSearch'][0])
    {
     ...
     */
    public function getWebhooksListenersSearchWithHttpInfo($space, $expand = null, $limit = null, $offset = null, $order = null, $query = null, string $contentType = self::contentTypes['getWebhooksListenersSearch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\PostFinanceCheckout\Sdk\Model\WebhookListenerSearchResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\PostFinanceCheckout\Sdk\Model\WebhookListenerSearchResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\PostFinanceCheckout\Sdk\Model\WebhookListenerSearchResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\PostFinanceCheckout\Sdk\Model\WebhookListenerSearchResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getWebhooksListenersSearchRequest($space, $expand = null, $limit = null, $offset = null, $order = null, $query = null, string $contentType = self::contentTypes['getWebhooksListenersSearch'][0])
    {
     ...
     */
    public function patchWebhooksListenersBulk($space, $webhook_listener_update, string $contentType = self::contentTypes['patchWebhooksListenersBulk'][0])
    {
     ...
     *
     * @param  int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param  \PostFinanceCheckout\Sdk\Model\WebhookListenerUpdate[] $webhook_listener_update (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['patchWebhooksListenersBulk'] to see the possible values for this operation
     *
     * @throws \PostFinanceCheckout\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function patchWebhooksListenersBulkWithHttpInfo($space, $webhook_listener_update, string $contentType = self::contentTypes['patchWebhooksListenersBulk'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchWebhooksListenersBulkRequest($space, $webhook_listener_update, string $contentType = self::contentTypes['patchWebhooksListenersBulk'][0])
    {
     ...
     */
    public function patchWebhooksListenersId($id, $space, $webhook_listener_update, $expand = null, string $contentType = self::contentTypes['patchWebhooksListenersId'][0])
    {
     ...
     */
    public function patchWebhooksListenersIdWithHttpInfo($id, $space, $webhook_listener_update, $expand = null, string $contentType = self::contentTypes['patchWebhooksListenersId'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchWebhooksListenersIdRequest($id, $space, $webhook_listener_update, $expand = null, string $contentType = self::contentTypes['patchWebhooksListenersId'][0])
    {
     ...
     * @return \PostFinanceCheckout\Sdk\Model\WebhookListener|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse
     */
    public function postWebhooksListeners($space, $webhook_listener_create, $expand = null, string $contentType = self::contentTypes['postWebhooksListeners'][0])
    {
     ...
     *
     * @param  int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param  \PostFinanceCheckout\Sdk\Model\WebhookListenerCreate $webhook_listener_create (required)
     * @param  string[] $expand (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postWebhooksListeners'] to see the possible values for this operation
     *
     * @throws \PostFinanceCheckout\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     ...
     * @return array of \PostFinanceCheckout\Sdk\Model\WebhookListener|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postWebhooksListenersWithHttpInfo($space, $webhook_listener_create, $expand = null, string $contentType = self::contentTypes['postWebhooksListeners'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postWebhooksListenersRequest($space, $webhook_listener_create, $expand = null, string $contentType = self::contentTypes['postWebhooksListeners'][0])
    {
     ...
     * @return \PostFinanceCheckout\Sdk\Model\RestApiBulkOperationResult[]|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse
     */
    public function postWebhooksListenersBulk($space, $webhook_listener_create, string $contentType = self::contentTypes['postWebhooksListenersBulk'][0])
    {
     ...
     * @return array of \PostFinanceCheckout\Sdk\Model\RestApiBulkOperationResult[]|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse|\PostFinanceCheckout\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postWebhooksListenersBulkWithHttpInfo($space, $webhook_listener_create, string $contentType = self::contentTypes['postWebhooksListenersBulk'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postWebhooksListenersBulkRequest($space, $webhook_listener_create, string $contentType = self::contentTypes['postWebhooksListenersBulk'][0])
    {
