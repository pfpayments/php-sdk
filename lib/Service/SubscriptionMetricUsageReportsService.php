...
class SubscriptionMetricUsageReportsService
{
    ...
    public function getSubscriptionsMetricUsageReportsWithHttpInfo($space, $after = null, $before = null, $expand = null, $limit = null, $order = null, string $contentType = self::contentTypes['getSubscriptionsMetricUsageReports'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\PostFinanceCheckout\Sdk\Model\MetricUsageReportListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\PostFinanceCheckout\Sdk\Model\MetricUsageReportListResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\PostFinanceCheckout\Sdk\Model\MetricUsageReportListResponse', []),
            ...
            $returnType = '\PostFinanceCheckout\Sdk\Model\MetricUsageReportListResponse';
    ...
    public function getSubscriptionsMetricUsageReportsIdWithHttpInfo($id, $space, $expand = null, string $contentType = self::contentTypes['getSubscriptionsMetricUsageReportsId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\PostFinanceCheckout\Sdk\Model\SubscriptionMetricUsageReport' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\PostFinanceCheckout\Sdk\Model\SubscriptionMetricUsageReport' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\PostFinanceCheckout\Sdk\Model\SubscriptionMetricUsageReport', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\PostFinanceCheckout\Sdk\Model\SubscriptionMetricUsageReport';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
    ...
    public function getSubscriptionsMetricUsageReportsSearchWithHttpInfo($space, $expand = null, $limit = null, $offset = null, $order = null, $query = null, string $contentType = self::contentTypes['getSubscriptionsMetricUsageReportsSearch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\PostFinanceCheckout\Sdk\Model\MetricUsageReportSearchResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\PostFinanceCheckout\Sdk\Model\MetricUsageReportSearchResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\PostFinanceCheckout\Sdk\Model\MetricUsageReportSearchResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\PostFinanceCheckout\Sdk\Model\MetricUsageReportSearchResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     *
     * @param  int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param  \PostFinanceCheckout\Sdk\Model\SubscriptionMetricUsageReportCreate $subscription_metric_usage_report_create (required)
     * @param  string[] $expand (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postSubscriptionsMetricUsageReports'] to see the possible values for this operation
     *
     * @throws \PostFinanceCheckout\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
