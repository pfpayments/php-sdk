...
/**
 * CurrencyBankAccountService service
 *
 * @category Class
...
class CurrencyBankAccountService {
	...
	public function countWithHttpInfo($space_id, $filter = null) {
		...
		// path params
		$resourcePath = '/currency-bank-account/count';
	...
	public function readWithHttpInfo($space_id, $id) {
		...
		// path params
		$resourcePath = '/currency-bank-account/read';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
		...
		try {
			...
			$response = $this->apiClient->callApi(
				...
				'/currency-bank-account/read'
			);
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\PostFinanceCheckout\Sdk\Model\CurrencyBankAccount', $response->getHeaders()));
		} catch (ApiException $e) {
			switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \PostFinanceCheckout\Sdk\Model\EntityQuery $query The query restricts the currency bank accounts which are returned by the search. (required)
	 * @throws \PostFinanceCheckout\Sdk\ApiException
	 * @throws \PostFinanceCheckout\Sdk\VersioningException
	 * @throws \PostFinanceCheckout\Sdk\Http\ConnectionException
	 * @return \PostFinanceCheckout\Sdk\Model\CurrencyBankAccount[]
	...
	public function searchWithHttpInfo($space_id, $query) {
		...
		// path params
		$resourcePath = '/currency-bank-account/search';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
